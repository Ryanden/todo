...
(function () {
  ...
  var completedLength = function completedLength() {
    completedNumber.innerHTML = todos.filter(function (todo) {
      return todo.completed;
    }).length;
  };
  ...
  var getTodos = function getTodos() {
    _axios2.default.get('/todos').then(function (_ref) {
      var data = _ref.data;
  ...
  var delTodo = function delTodo(id) {
    _axios2.default.delete('/todos/id/' + id).then(function (_ref3) {
      var data = _ref3.data;
  ...
  var toggleTodoComplete = function toggleTodoComplete(id) {
    ...
    _axios2.default.patch('/todos/id/' + id, { completed: !completed }) // payload: { completed }
    .then(function (_ref4) {
      var data = _ref4.data;
  ...
  var toggleAllComplete = function toggleAllComplete(obj) {
    _axios2.default.patch('/todos', { completed: obj.checked }) // payload: { completed }
    .then(function (_ref5) {
      var data = _ref5.data;
